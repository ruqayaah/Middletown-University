...
<head>
    ...
    <title>Middletown University (MU) | Home</title>
...
<body>
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active header" data-interval="10000">
                <img src="img/Outdoor_1_0.jpg" class="d-block w-100" alt="Let the Journey begin">
                    <p class="btn btn-danger bg-transparent font-weight-bold header-content2">Taste the Middletown <span class="text-danger">difference</span></p>
        <!-- <div class="image min-vh-100"></div> -->
      </div>
            <div class="carousel-item" data-interval="5000">
                <img src="img/uni.jpg" class="d-block w-100" alt="Taste the MU difference!">
                    <p class="btn btn-danger bg-transparent font-weight-bold header-content2">Propagating Virtue and <span class="text-danger">Excellence</span> since Forever...</p>
        <div class="image min-vh-100" ></div>
      </div>
            <div class="carousel-item">
                <img src="img/1gqf.gif" class="d-block w-100" alt="Propagating Virtue and Excellence since Forever...">
        <div class="image min-vh-100"></div>
      </div>
    </div>
