...
<head>
    ...
    <title>Middletown University (MU) | Your Dashboard</title>
...
<body>
    <div class="container-fluid">
        ...
        <div class="row jumbotron">
            ...
            <div>
                <ul>
                    <li class="btn btn-danger"><a href="login.php" class="text-decoration-none text-white">My MiddletownUni</a></li>
                </ul>
            </div>
            </div>
        </div>
        ...
        <div class="row footerbg text-white">
                ...
                <div class="col-md-4 header">
                    ...
                    <h3 class="header-content ml-5">Middletown University<br>&copy 2019</h3>

                </div>
                <div class="col-md-4"></div>
                <div class="col-md-4 blockquote-footer">
                    <address class="add mr-5">
                        <span class="text-danger">Middletown University</span><br>
